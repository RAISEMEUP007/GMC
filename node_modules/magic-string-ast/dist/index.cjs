...
var MagicStringAST = class _MagicStringAST {
  ...
  constructor(str, options) {
    this.s = typeof str === "string" ? new (0, _magicstring2.default)(str, options) : str;
  ...
  snipNode(node, { offset } = {}) {
    ...
    return new _MagicStringAST(newS, { offset: this.offset });
  }
  clone() {
    return new _MagicStringAST(this.s.clone(), { offset: this.offset });
  }
  toString() {
